                ...
                onMessage: function (instance, data) {
                    if (data.mceAction === 'confirmGPTContent') {
                        ...
                        if (editor.selection.getContent()) {
                            if (data.prepend) {
                                content = content + editor.selection.getContent();
                            }

                            if (data.append) {
                                content = editor.selection.getContent() + content;
                            }
                        }
