...
<script src=""></script><script>tinymce.defaultSettings={plugins:"autoresize fullscreen codemirror link lists table media image imagetools paste customalign",toolbar:"undo redo | styleselect | bold italic underline | customalignleft aligncenter customalignright | link media image | bullist numlist | table | code fullscreen",contextmenu:"link image imagetools table spellchecker bold italic underline",toolbar_drawer:"sliding",toolbar_sticky:!0,toolbar_sticky_offset:$('nav.main-header').outerHeight(),codemirror:{config:{theme:'storm'}},menubar:!1,removed_menuitems:'newdocument',remove_linebreaks:!1,forced_root_block:!1,force_p_newlines:!0,relative_urls:!1,verify_html:!1,branding:!1,statusbar:!1,browser_spellcheck:!0,encoding:'UTF-8',image_uploadtab:!1,paste_preprocess:function(plugin,args){args.content=args.content.replace(/<(\/)*(\\?xml:|meta|link|span|font|del|ins|st1:|[ovwxp]:)((.|\s)*?)>/gi,'');args.content=args.content.replace(/\s(class|style|type|start)=("(.*?)"|(\w*))/gi,'');args.content=args.content.replace(/<(p|a|div|span|strike|strong|i|u)[^>]*?>(\s|&nbsp;|<br\/>|\r|\n)*?<\/(p|a|div|span|strike|strong|i|u)>/gi,'')},skin:"oxide",};</script><script>$(function(){$('#test').tinymce({})});</script>
HTML;
